...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-4a228b2fc1cc1b79"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-4a228b2fc1cc1b79",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-4a228b2fc1cc1b79",
        "url": "https://en.wikipedia.org/wiki/Lindel%C3%B6f_hypothesis"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Lindelöf hypothesis that for all $\\varepsilon >0$ , $\\zeta (1/2+it)=o(t^{\\varepsilon })$",
      "version": 1
    },
    "title": "Lindelöf hypothesis",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "d3b24ea3fca260b2c8b7621f4be1892c685b10bb104771f09e0c21315f77b855"
}
```
